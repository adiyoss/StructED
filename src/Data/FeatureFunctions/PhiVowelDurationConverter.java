    ...
    public Example convert(Example example, String label, Kernel kernel) {
        ...
        try{
            ...
            if(ConverterHelplers.tryParseInt(labelValues[0])) {
                ...
                //====Short Term Energy====//
//                phiFeatures.put(loc, calculateDiff(example, win_size_10, start, SHORT_TERM_ENERGY));//short term energy, start location - 20 window
//                loc++;
...
//                loc++;
                ...
                loc++;
//                phiFeatures.put(loc, calculateMean(example, start, end, F_1, win_size_30, true));//Mean of F1
//                loc++;
//                phiFeatures.put(loc, calculateMean(example, start, end, F_2, win_size_30, true));//Mean of F2
//                loc++;
